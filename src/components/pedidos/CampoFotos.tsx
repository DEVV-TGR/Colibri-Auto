    ...
    <div className="sm:col-span-2">
          ...
          {fotos.map((f, i) => (
            <li key={f.url} className="relative">
              ...
              <button
                ...
                className="press absolute -right-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full border border-line bg-surface text-sm text-muted hover:border-laranja hover:text-laranja-deep"
              >
                ×
              </button>
            </li>
      ...
      <div className="flex flex-wrap items-center gap-4">
        <button
          ...
          className="press inline-flex items-center justify-center gap-2 rounded-full border border-laranja px-6 py-3 text-sm tracking-wide text-ink hover:border-laranja hover:text-laranja-deep disabled:opacity-60"
        >
          {aPreparar
            ? "A preparar…"
            : fotos.length === 0
